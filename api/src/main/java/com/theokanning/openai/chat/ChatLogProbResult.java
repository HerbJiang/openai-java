 ...
 * Returned if {@link ChatCompletionRequest#logprobs} is greater than zero
 *
...
public class ChatLogProbResult {
     ...
     * The map contains the top {@link ChatCompletionRequest#logprobs} tokens and their probabilities
     */
